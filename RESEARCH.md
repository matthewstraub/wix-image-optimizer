...
3. **Do not sharpen.** This is the opposite of standard advice for downscaling,
   ...
   Turning our sharpening off made files *both* smaller *and* better.
...
Not sharpening is **strictly dominant** — smaller files *and* better quality,
...
4:4:4 is worth the bytes here specifically *because* Wix re-encodes: chroma
...
- [Wix Studio forum: *Worse Image Compression PROOF*](https://forum.wixstudio.com/t/worse-image-compression-proof-need-disable-compression-option/64928) — users reproducing the double-compression effect
- [cloudinary/ssimulacra2](https://github.com/cloudinary/ssimulacra2) — the metric and its calibration points
- [Jon Sneyers: *Contemplating Codec Comparisons*](https://cloudinary.com/blog/contemplating-codec-comparisons) — why codec wins shrink at web-relevant bitrates
- [Malte Ubl: *AVIF and WebP quality settings*](https://www.industrialempathy.com/posts/avif-webp-quality-settings/) — cross-codec quality mapping
